...
const ArrowButton = forwardRef<HTMLButtonElement, IArrowButton>(
  ({ direction, className, isScrolling }, ref) => { // Accept ref
    ...
    return (
      <button
        ref={ref} // Pass ref to the button element
        onClick={() => {
          detectClick();
        }}
        className={tw(
...
ArrowButton.displayName = "ArrowButton"; // Add display name for better debugging
